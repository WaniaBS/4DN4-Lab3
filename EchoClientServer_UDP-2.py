...
class Server:
    ...
    sdp_socket = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
    sdp_socket.bind(("", SDP_PORT))
    ...
    def create_listen_socket(self):
        ...
        while True:
            ...
            if data.decode() == SDP_MESSAGE:
                name = "Yang's File Sharing Service"
                sdp_socket.sendto(name.encode(), addr)
